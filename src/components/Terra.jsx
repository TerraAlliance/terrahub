  ...
  return (
    <group position={position}>
      <group ref={group} rotation={[0, -Math.PI / 2, Math.PI / 2]}>
        <animated.mesh material={material} position={explode.to((v) => [-v, 0, -v])} scale={scale} geometry={nodes.Sphere.geometry}></animated.mesh>
        <animated.mesh material={material} position={explode.to((v) => [-v, 0, v])} scale={scale} geometry={nodes.Sphere1.geometry}></animated.mesh>
        <animated.mesh material={material} position={explode.to((v) => [v, 0, -v])} scale={scale} geometry={nodes.Sphere2.geometry}></animated.mesh>
        <animated.mesh material={material} position={explode.to((v) => [v, 0, v])} scale={scale} geometry={nodes.Sphere3.geometry}></animated.mesh>
      </group>
      <animated.mesh
        geometry={sphere}
        scale={scale}
